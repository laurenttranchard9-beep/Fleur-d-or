...
**Carte A3 à imprimer :** le lien **Carte A3** du panneau ouvre la carte papier (A3 paysage, recto-verso, pli roulé en 3 volets de 141 / 141 / 138 mm), générée à partir des mêmes données que le site. Elle est claire (papier crème, prix en brique ; seule la couverture garde le mur de briques) et la taille du texte s’ajuste pour tout faire tenir. Une catégorie n’est jamais coupée entre l’intérieur, le rabat et le dos. Elle se met à jour toute seule. Cliquez sur « Imprimer ou enregistrer en PDF », en A3 paysage, recto-verso bord court, sans marges et avec les graphiques d’arrière-plan. Le format « imprimeur » ajoute 3 mm de fonds perdus. Une formule dont la case « Imprimer sur la carte A3 » est décochée (la fondue) n’y figure pas. Les PDF du 25 septembre 2026 sont dans `impression/`.
