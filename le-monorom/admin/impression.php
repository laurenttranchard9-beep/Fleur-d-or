<?php
/*
 * Le Monorom : morceaux de la carte A3 à imprimer (carte-a3.php).
        ...
        foreach ($sections as $i => $s) {
            ...
            if ($i === count($sections) - 1) {
                ...
                if ($n === count($quartiers) - 1) {
                    $apres .= '<p class="c-legende">' . trim(a3_piment()) . ' pimenté · espèces, carte bancaire dès 10 €, Chèque Déjeuner, Ticket Restaurant.</p>';
                }
            }
