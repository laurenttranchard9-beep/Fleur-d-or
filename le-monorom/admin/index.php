<?php
/* Le Monorom : panneau d'administration (connexion et application). */
...
<title>Administration · Le Monorom</title>
...
<header class="a-poutre">
  <p class="a-marque"><span class="a-disque" aria-hidden="true"><svg class="lune" viewBox="0 0 24 24" aria-hidden="true"><path d="M14.6 3.1a9.2 9.2 0 1 0 6.3 14.4 7.6 7.6 0 0 1-6.3-14.4Z" fill="currentColor"/></svg></span><span class="a-marque-nom">Le Monorom</span><span class="a-marque-role">Administration</span></p>
  <?php if ($etat === 'app'): ?>
