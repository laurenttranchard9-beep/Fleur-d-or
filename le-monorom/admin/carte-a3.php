<?php
/*
 * Le Monorom : carte A3 à imprimer (pli roulé, 3 volets, recto-verso).
...
<title><?= $modele !== '' ? fd_e(A3_MODELES[$modele]) . ' · ' : '' ?>Carte A3 · Le Monorom</title>
...
<div class="c-apercu" data-apercu>
  <section class="c-feuille c-recto" aria-label="Recto : extérieur de la carte">
    ...
    <div class="c-volet c-v3 c-couv">
      <div class="c-marque">
        <p class="c-enseigne" aria-hidden="true"><span><svg class="lune" viewBox="0 0 24 24" aria-hidden="true"><path d="M14.6 3.1a9.2 9.2 0 1 0 6.3 14.4 7.6 7.6 0 0 1-6.3-14.4Z" fill="currentColor"/></svg></span></p>
        <h1 class="c-nom-resto">Le Mono<span>rom</span></h1>
        <p class="c-accroche">Spécialités japonaises et thaïlandaises · Bar à sushis</p>
        <p class="c-contact">Sur place ou à emporter · <b>05 63 29 23 81</b></p>
        <p class="c-horaires"><b>Du mardi au dimanche</b> 10h – 14h et 18h – 22h · fermé le lundi<br>12 chemin de Benis, croisement route de Toulouse, 82100 Castelsarrasin</p>
      </div>
      <div class="c-ardoise">
