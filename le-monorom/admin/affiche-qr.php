<?php
/*
 * Le Monorom : affiche « Scannez pour accéder au menu » avec un QR code vers la carte du site.
...
function qr_affiche(string $lien, string $visible, string $classe): string
{
    return '<article class="q-affiche ' . $classe . '">'
        . '<header class="q-tete">'
        . '<p class="q-enseigne" aria-hidden="true"><span><svg class="lune" viewBox="0 0 24 24" aria-hidden="true"><path d="M14.6 3.1a9.2 9.2 0 1 0 6.3 14.4 7.6 7.6 0 0 1-6.3-14.4Z" fill="currentColor"/></svg></span></p>'
        . '<p class="q-nom">Le Mono<span>rom</span></p>'
        . '<p class="q-accroche">Spécialités japonaises et thaïlandaises · Bar à sushis</p>'
        . '</header>'
        . '<div class="q-corps">'
        ...
        . '</div>'
        . '<footer class="q-pied">Sur place ou à emporter · <b>05 63 29 23 81</b></footer>'
        . '</article>';
}
...
function qr_etiquette(string $lien, string $visible): string
{
    return '<article class="q-etiquette">'
        ...
        . '<p class="q-pied"><b>05 63 29 23 81</b></p>'
        . '</div></article>';
}

/** Étiquette carrée : titre en haut, code au centre, nom et téléphone en bas. */
function qr_carre(string $lien, string $visible): string
{
    return '<article class="q-carre">'
        . '<p class="q-titre">Scannez pour<br>accéder au menu</p>'
        . '<div class="q-cadre"><div class="q-code" data-qr="' . fd_e($lien) . '" role="img" aria-label="QR code vers la carte : ' . fd_e($visible) . '"></div></div>'
        . '<p class="q-nom"><span class="q-disque" aria-hidden="true"><svg class="lune" viewBox="0 0 24 24" aria-hidden="true"><path d="M14.6 3.1a9.2 9.2 0 1 0 6.3 14.4 7.6 7.6 0 0 1-6.3-14.4Z" fill="currentColor"/></svg></span><span>Le Mono<i>rom</i> · <b>05 63 29 23 81</b></span></p>'
        . '</article>';
}
...
?>
<!DOCTYPE html>
<html lang="fr" class="q-<?= ['etiquette' => 'une', 'carre' => 'page-carree'][$format] ?? $format ?>">
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="robots" content="noindex, nofollow">
<title>Affiche QR code · Le Monorom</title>
